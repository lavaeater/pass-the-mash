...
///** @author Xoppa
// */
//class ContactCallbackTest : BaseBulletTest() {
...
//    class TestContactProcessedListener : ContactListener() {
//        var entities: Array<BulletEntity?>? = null
//        var c = 0
//        override fun onContactProcessed(userValue0: Int, match0: Boolean, userValue1: Int, match1: Boolean) {
//            if (match0) {
//                val e = entities!![userValue0]
//                // Disable future callbacks for this entity
//                e!!.body!!.contactCallbackFilter = 0
//                e.color = Color.RED
//                Gdx.app.log("ContactCallbackTest", "Contact processed " + ++c)
//            }
//            if (match1) {
//                val e = entities!![userValue1]
//                // Disable future callbacks for this entity
//                e!!.body!!.contactCallbackFilter = 0
//                e.color = Color.RED
//                Gdx.app.log("ContactCallbackTest", "Contact processed " + ++c)
...
//    val BOXOFFSET_Z = -5f
//    var contactProcessedListener: TestContactProcessedListener? = null
//    override fun create() {
//        super.create()
//
//        // Create the entities
...
//        contactProcessedListener = TestContactProcessedListener()
